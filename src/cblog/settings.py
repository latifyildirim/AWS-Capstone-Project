...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.c33ndfedld89.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstoneslatifblog' # please enter your s3 bucket name
